...
> 在飞书、钉钉或企业微信中通过对话创建定时任务，到点自动抓取多平台热榜并推送。
...
**Q: 飞书、钉钉、企业微信的任务可以共用吗？**  
A: 不能。三个平台各自维护任务列表，在哪个平台创建的任务会推送到哪个平台。
...
- [部署检查清单](news-push-deployment-checklist.md)
